"""
Code for training distilled bert-base model using Confidence Regulatization Method
Using Smoothed Distillation Loss

Code is a rework of https://github.com/UKPLab/acl2020-confidence-regularization
...
def main():
    ...
    ## Our arguements
    parser.add_argument("--mode", choices=["none", "distill", "smoothed_distill", "reweight_baseline",
    ...
    parser.add_argument("--sorted", action="store_true",
                        help='Sort the data so most batches have the same input length,'
                             ...
                             'its off by default.')
    parser.add_argument("--which_bias", choices=["hans", "hypo", "hans_json"], required=True)
